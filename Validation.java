...
public class Validation {
    ...
    public boolean validateDob(String dob) {
        String dateValidate1 = "^(0[1-9]|[12][0-9]|3[01])/(0[1-9]|1[012])/(19[0-9][0-9]|20[0][1])$";
        String dateValidate2 = "^(0[1-9]|1[012])/(0[1-9]|[12][0-9]|3[01])/(19[0-9][0-9]|20[0][1])$";
        if(Pattern.matches(dateValidate1, dob) || Pattern.matches(dateValidate2, dob)){
            return true;
        }else{
            return false;
        }
